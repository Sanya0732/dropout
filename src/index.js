...
app.post("/addstudent", async (req, res) => {
    ...
    const { name, age, gender, caste, admittedIn, droppedOutIn, reason } = req.body;

    try {
        // Create new student record in MongoDB
        const newStudent = await Student.create({ name, age, gender, caste, admittedIn, droppedOutIn, reason });
